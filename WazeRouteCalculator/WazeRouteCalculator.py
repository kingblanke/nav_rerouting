...
class WazeRouteCalculator(object):
    ...
    def __init__(self, start_address, end_address, region='EU', log_lvl=logging.INFO):
        ...
        self.start_coords = {'lon':start_address[1], 'lat':start_address[0], 'bounds': {}} #self.address_to_coords(start_address)
        self.log.debug('Start coords: (%s, %s)', self.start_coords["lon"], self.start_coords["lat"])
        self.end_coords =  {'lon':end_address[1], 'lat':end_address[0], 'bounds': {}} #self.address_to_coords(end_address)
    ...
    def address_to_coords(self, address):
        ...
        if bounds is not None:
            ...
            bounds = {}
        return {"lon": lon, "lat": lat, "bounds": {}} #bounds used to be bounds
    ...
    def _add_up_route(self, results, real_time=True, stop_at_bounds=False):
        ...
        return route_time, route_distance, route_coordinates
    ...
    def calc_route_info(self, real_time=True, stop_at_bounds=False, time_delta=0):
        ...
        route_time, route_distance, route_coordinates = self._add_up_route(results, real_time=real_time, stop_at_bounds=stop_at_bounds) #don't need route_coords
        self.log.info('Time %.2f minutes, distance %.2f km.', route_time, route_distance)
        return route_time, route_distance

    def calc_all_routes_info(self, npaths=4, real_time=True, stop_at_bounds=False, time_delta=0):
